...
public class FontHandler extends StyledTextHandler {
	...
	public void handleTagNode(TagNode node, SpannableStringBuilder builder,
        ...
        if ( getSpanner().isAllowStyling() ) {
            ...
            if ( size != null ) {
                CSSCompiler.StyleUpdater updater = CSSCompiler.getStyleUpdater("font-size", size, false);
            ...
            if ( color != null && getSpanner().isUseColoursFromStyle() ) {
                ...
                CSSCompiler.StyleUpdater updater = CSSCompiler.getStyleUpdater("color", color, false);
